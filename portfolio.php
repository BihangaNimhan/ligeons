                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title text-white">Portfolio - Left Sidebar 4 Col</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.html"> Home </a></li>
                                            <li class="breadcrumb-item"><a href="#"> Protfolio </a></li>
                                            <li class="breadcrumb-item"><a href="#"> Left Sidebar </a></li>
                                            <li class="breadcrumb-item active"> 4 Col </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-xl-9">
                                    ...
                                    <div class="row masonary-block grid">
                                        ...
                                        <div class="gallery-item col-md-6 col-lg-3 col-xl-3 ecommerce">
                                            <figure class="caption-hover-full">
                                                <a class="fancy-pop" href="portfolio-single.html"></a>
                                        ...
                                        <div class="gallery-item col-md-6 col-lg-3 col-xl-3 programming ui">
                                            <figure class="caption-hover-full">
                                                <a class="fancy-pop" href="portfolio-single.html"></a>
                                        ...
                                        <div class="gallery-item col-md-6 col-lg-3 col-xl-3 programming">
                                            <figure class="caption-hover-full">
                                                <a class="fancy-pop" href="portfolio-single.html"></a>
